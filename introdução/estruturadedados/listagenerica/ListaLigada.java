...
public class ListaLigada<TIPO> {
    ...
    public void adicionar(TIPO novoValor) {
        Nodo<TIPO> novoNodo = new Nodo<TIPO>(novoValor); //o valor passa para dentro do elemento
    ...
    public void remover(TIPO valorProcurado) {
        ...
        Nodo<TIPO> anterior = null; //porque antes do primeiro não possui anterior; a variável anterior também anda com a atual e o i
        ...
        for(int i = 0; i < this.getTamanho(); i++) { //como ele não sabe onde está o elemento, usa o getTamanho
            if (atual.getValor().equals(valorProcurado)) { //quer saber se o atual tem o valor procurado
